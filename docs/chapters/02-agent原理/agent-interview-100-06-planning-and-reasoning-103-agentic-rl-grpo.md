...
> **资料来源**：[Agent Interview 100](https://github.com/BigKunLun/Agent-Interview-100) · 原文件：`06-planning-and-reasoning/103-agentic-rl-grpo.md`。
...
| Advantage 计算 | A = R - V(s)
依赖 Value Function | A = (r-mean)/std
依赖组内相对排名 |
