...
> **资料来源**：[Agent Interview Hub](https://github.com/Zchary1106/agent-interview-hub) · 原文件：`通用知识/Agent核心概念与设计模式.md`。
...
![Agent Loop 循环](/original-assets/agent-interview-hub/diagrams/agent-loop-cycle.svg)
...
##### Supervisor 模式
![Supervisor 多 Agent 分发](/original-assets/agent-interview-hub/diagrams/supervisor-multi-agent-simple.svg)
