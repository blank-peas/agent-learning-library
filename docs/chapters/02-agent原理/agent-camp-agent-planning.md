...
> **资料来源**：[Agent Camp](https://github.com/yibo365/agent-camp) · 原文件：`agent/planning.md`。
...
## 规划算法 Planning
  ...
  Agent 规划要在状态、动作、约束和反馈之间搜索可执行路径。

  
    适合阶段：复杂任务分解
    核心机制：State / Action / Search / Replan
    面试重点：搜索空间与可执行性
...
读完这篇你要能正面回答下面这些题。每题后面括号里是面试官真正想看你答出什么。
    ...
    Agent 里的 planning 和普通任务拆解有什么区别？
    考状态、动作前置条件、后置效果和反馈。
  

  
    HTN、Tree of Thoughts、MCTS 在 LLM Agent 里分别怎么用？
    考算法思想，而不是背名词。
    ...
    规划时怎么控制搜索空间？
    考 beam、启发式、深度限制、动作白名单。
  

  
    什么时候需要 replan？什么时候只需要 retry？
    考失败分类和状态更新。
  

  
    计划质量怎么评估？
    考 completeness、validity、cost、dependency violation。
  

  
    规划算法和 Agent memory 有什么关系？
    考长期偏好、历史失败、可复用技能。
