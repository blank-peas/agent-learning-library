...
> **资料来源**：[Agent Interview Hub](https://github.com/Zchary1106/agent-interview-hub) · 原文件：`通用知识/大模型推理优化与部署.md`。
...
![大模型推理服务部署拓扑](/original-assets/agent-interview-hub/diagrams/llm-serving-topology.svg)
