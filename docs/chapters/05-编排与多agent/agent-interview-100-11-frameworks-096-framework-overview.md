...
> **资料来源**：[Agent Interview 100](https://github.com/BigKunLun/Agent-Interview-100) · 原文件：`11-frameworks/096-framework-overview.md`。
...
| GitHub Stars（截至 2025 年） | 100k+ | 40k+ | 18k+ |
| 语言 | Python + TS | Python + TS | Python |
| 核心抽象 | Chain/Agent/Tool | Index/Query Engine | Pipeline/Component |
| Agent 能力 | ★★★★★ | ★★★☆☆ | ★★★★☆ |
| RAG 能力 | ★★★★☆ | ★★★★★ | ★★★★☆ |
| 生产就绪 | ★★★☆☆ | ★★★☆☆ | ★★★★★ |
| 学习曲线 | 陡峭 | 中等 | 平缓 |
