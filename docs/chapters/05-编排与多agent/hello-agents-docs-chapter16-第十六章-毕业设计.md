...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`docs/chapter16/第十六章 毕业设计.md`。
...
- 数据集1: [百度网盘](https://github.com/datawhalechina/hello-agents) 提取码: xxxx
- 数据集2: [Google Drive](https://github.com/datawhalechina/hello-agents)
- 演示视频: [B站](https://github.com/datawhalechina/hello-agents) / [YouTube](https://github.com/datawhalechina/hello-agents)
```
...
- 完整数据集（10万条记录）请从[这里](https://github.com/datawhalechina/hello-agents)下载
```
...
#### 演示视频
- B站: [项目演示视频](https://github.com/datawhalechina/hello-agents)
