...
> **资料来源**：[AI Agent Interview Guide](https://github.com/bcefghj/ai-agent-interview-guide) · 原文件：`docs/01-面试八股文/06-多智能体.md`。


![多Agent协作](/original-assets/ai-agent-interview-guide/comics/04-多Agent协作.png)
...
class BossWorker:
    ...
    def run(self, task: str) -> Dict[str, str]:
        ...
        for st in subtasks:
            name = st["agent"]
            results[name] = self.workers[name](https://github.com/bcefghj/ai-agent-interview-guide)
        return results
