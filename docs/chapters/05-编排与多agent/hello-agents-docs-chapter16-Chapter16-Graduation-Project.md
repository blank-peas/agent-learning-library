...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`docs/chapter16/Chapter16-Graduation-Project.md`。
...
- Dataset 1: [Baidu Netdisk](https://github.com/datawhalechina/hello-agents) Extraction code: xxxx
- Dataset 2: [Google Drive](https://github.com/datawhalechina/hello-agents)
- Demo video: [Bilibili](https://github.com/datawhalechina/hello-agents) / [YouTube](https://github.com/datawhalechina/hello-agents)
```
...
- Complete dataset (100,000 records) download from [here](https://github.com/datawhalechina/hello-agents)
```
...
#### Demo Video
- Bilibili: [Project Demo Video](https://github.com/datawhalechina/hello-agents)
- YouTube: [Demo Video](https://github.com/datawhalechina/hello-agents)
```
