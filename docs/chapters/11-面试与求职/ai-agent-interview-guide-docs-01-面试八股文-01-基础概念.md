...
> **资料来源**：[AI Agent Interview Guide](https://github.com/bcefghj/ai-agent-interview-guide) · 原文件：`docs/01-面试八股文/01-基础概念.md`。
...
def run_agent(user_goal: str, tools: dict, llm, max_steps: int = 8):
    ...
    for _ in range(max_steps):
        ...
        obs = tools[action.name](https://github.com/bcefghj/ai-agent-interview-guide)
