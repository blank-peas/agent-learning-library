# Agent 业务效果与 ROI 面试深挖：别只说“有多少人用了”

> **资料来源**：[Agent Camp](https://github.com/yibo365/agent-camp) · 原文件：`engineering/business-roi-interview.md`。
...
## Agent 业务效果与 ROI 面试深挖：别只说“有多少人用了”
  ...
  面试官问上线效果，不是在问访问量，而是在问这个 Agent 到底替用户、团队或业务省下了什么。

  
    适合阶段：Agent 工程师 / 技术负责人面
    核心能力：任务完成 · 自动化率 · 成本归因 · A/B 验证
    脱敏原则：只保留指标方法，不保留真实业务数字
...
这组问题经常决定面试官把你当“做过 demo 的工程师”，还是“能把 AI 应用落地到业务结果的人”。
    ...
    Agent 上线后效果怎么样？除了 DAU 和请求量还有什么？
    考你能不能从流量指标切到任务完成、自动化、体验和成本。
  

  
    怎么证明是 Agent 带来的提升，而不是自然增长或运营活动？
    考 A/B、灰度、双跑、cohort 和前后对比的归因意识。
  

  
    一个 Agent 的北极星指标应该是什么？
    考你会不会按场景定义，而不是所有 Agent 都看满意度。
  

  
    任务完成率、自动化率、转人工率、满意度冲突时看哪个？
    考指标优先级和安全边界。
  

  
    AI 替代人工，怎么计算 ROI？
    考节省成本、增量收入、质量损失、模型成本和运营成本的完整账。
  

  
    为什么“AI 解决率很高”也可能是坏指标？
    考重复咨询、误解决、用户沉默和人工回流。
  

  
    技术指标和业务效果怎么打通？
    考 trace 到 outcome 的链路：意图、工具、回复、用户行为和最终结果。
  

  
    你会怎么向老板汇报 Agent 价值？
    考能不能把工程语言翻译成容量、成本、风险和增长。
