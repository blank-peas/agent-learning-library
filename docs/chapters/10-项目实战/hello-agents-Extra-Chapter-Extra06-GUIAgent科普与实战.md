...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Extra-Chapter/Extra06-GUIAgent科普与实战.md`。
...
一个完整的 GUI Agent 系统可以被分解为三个核心模块：**感知（Perception）** → **推理（Reasoning）** → **执行（Action）**。这是一个闭环的自主决策系统。
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra06-figures/image1.png" alt="GUI Agent 三层架构" width="90%"/>
...
2024-2025年是 GUI Agent 的爆发期，各大科技公司和研究机构纷纷开源了自己的框架。让我们系统地对比几个最具代表性的项目：
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra06-figures/image2.png" alt="主流GUI Agent框架对比" width="90%"/>
...
3. **交互区**：左下角为指令输入区，Agent 的思考过程（Thinking Process）和操作步骤将显示在上方对话框中。
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra06-figures/image3.png" alt="ModelScope Demo界面" width="90%"/>
...
对于 Windows 用户，可能还需要安装手机的驱动程序。大部分品牌的手机（如小米、华为、OPPO）都会在连接电脑时自动安装驱动，但如果遇到问题，可以去官网下载对应的 USB 驱动。
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra06-figures/image4.png" alt="手机ADB连接配置步骤" width="90%"/>
