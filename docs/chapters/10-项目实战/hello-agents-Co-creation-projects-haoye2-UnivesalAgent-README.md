...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Co-creation-projects/haoye2-UnivesalAgent/README.md`。
...
详细说明请参考：[CONFIG_GUIDE.md](https://github.com/datawhalechina/hello-agents)
...
- 详细配置说明请查看：[CONFIG_GUIDE.md](https://github.com/datawhalechina/hello-agents)
