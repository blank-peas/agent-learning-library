...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Co-creation-projects/alexrunner-DataAnalysisAgent/README.md`。
...
![图1：各年龄段平均购买金额对比](https://github.com/datawhalechina/hello-agents)
*图1：青少年（<20）平均消费最高，40-49岁群体消费最低。*

![图2：不同性别客户的品类偏好分布](https://github.com/datawhalechina/hello-agents)
