...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Extra-Chapter/Extra12-旅行助手后训练实战.md`。
...
![后训练主线总览图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/01-后训练主线总览图.png)
...
![开篇 Case 前后对比图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/02-开篇Case前后对比图.png)
...
![产品协议改造图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/03-产品协议改造图.png)
...
![评测集冻结图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/04-评测集冻结图.png)
...
![SFT 数据生成与审计漏斗图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/05-SFT数据生成与审计漏斗图.png)
...
![LoRA 多阶段训练时间线图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/06-LoRA多阶段训练时间线图.png)
...
![全参 SFT 与 LoRA 对比图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/18-全参SFT与LoRA对比图.png)
...
![Best-of-N Replay 与 Rerank 图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/07-Best-of-N-Replay与Rerank图.png)
...
![SFT Rerank 对比图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/09-sft-rerank-comparison.png)
...
![DPO 样本筛选与防泄漏图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/12-DPO样本筛选与防泄漏图.png)

#### 主指标换成 PlannerSoft

后来我越来越觉得，普通 softpass 还不够。旅行助手输出的不是一道选择题，而是一份用户可能真的拿去用的计划。所以主指标逐步转成 `planner soft`：预算贴合、餐饮重复、景点重复、预算关系这些都要看。

![PlannerSoft 指标分解图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/16-PlannerSoft指标分解图.png)
...
![DPO loss 跨批次不可比图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/15-DPO-loss跨批次不可比图.png)
...
![单生成与多候选 Rerank 对比图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/17-单生成与多候选Rerank对比图.png)
...
![DPO 收尾 Rerank 效果图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/10-dpo-rerank-closing.png)
...
![MiMo 外部参考对比图](/original-assets/hello-agents/Extra-Chapter/images/Extra12-figures/11-mimo-reference-comparison.png)
