...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Co-creation-projects/Apricity-InnocoreAI/README.md`。
...
[![License](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/datawhalechina/hello-agents)

*基于多智能体协作的科研全流程自动化系统*

*基于 HelloAgent 框架构建，支持灵活的 LLM 切换*

[English](https://github.com/datawhalechina/hello-agents) | 简体中文
...
#### 主界面 - 双模式切换
![主界面](/original-assets/hello-agents/Co-creation-projects/Apricity-InnocoreAI/docs/screenshots/01-主界面.png)

#### 论文搜索功能
![论文搜索](/original-assets/hello-agents/Co-creation-projects/Apricity-InnocoreAI/docs/screenshots/02-论文搜索.png)

#### 深度分析功能
![论文分析](/original-assets/hello-agents/Co-creation-projects/Apricity-InnocoreAI/docs/screenshots/03-论文分析.png)
...
本项目采用 MIT 许可证 - 详见 [LICENSE](https://github.com/datawhalechina/hello-agents) 文件
