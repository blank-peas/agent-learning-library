...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Co-creation-projects/AstrumPush-Smart-Recipe-Agent/README.md`。
...
本项目采用 [MIT License](https://github.com/datawhalechina/hello-agents) 开源协议，可自由使用、修改和分发。
...
- 💡 有新想法？欢迎开启 [Discussion](https://github.com/datawhalechina/hello-agents)
- ⭐ 喜欢这个项目？点个 Star 支持一下！
