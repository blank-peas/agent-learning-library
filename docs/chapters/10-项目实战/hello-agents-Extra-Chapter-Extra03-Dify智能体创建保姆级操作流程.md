...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Extra-Chapter/Extra03-Dify智能体创建保姆级操作流程.md`。
...
在构建智能体之前，需要先完成必要的插件安装和 MCP 配置。如图1所示，按照图中文字指示一步步安装本章节所需插件。
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image1.jpg" alt="插件安装示意图" width="90%"/>
  图1 插件安装示意图
...
(2) 注册账号并登录，如图2所示
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image2.jpg" alt="ModelScope注册登录界面" width="90%"/>
  图2 ModelScope注册登录界面
...
(3) 进入高德地图MCP配置页面
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image3.jpg" alt="高德地图MCP入口指引" width="90%"/>
  图3 高德地图MCP入口指引
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image4.jpg" alt="高德地图MCP配置页面" width="90%"/>
  图4 高德地图MCP配置页面
...
(4) 进入高德开放平台：[https://console.amap.com/dev/index](https://console.amap.com/dev/index)
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image5.jpg" alt="高德开放平台新建应用" width="90%"/>
  图5 高德开放平台新建应用
...
(5) 创建api_key
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image6.jpg" alt="创建api_key步骤" width="90%"/>
  图6 创建api_key步骤
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image7.jpg" alt="MCP配置成功页面" width="90%"/>
  图7 MCP配置成功页面
...
整个智能体的编排架构如图8所示。
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image8.jpg" alt="智能体编排架构图" width="90%"/>
  图8 智能体编排架构图
...
- 按照图9及图10，一步步创建Chatflow空白应用
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image9.jpg" alt="创建Chatflow步骤1" width="90%"/>
  图9 创建Chatflow步骤1
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image10.jpg" alt="创建Chatflow步骤2" width="90%"/>
  图10 创建Chatflow步骤2
...
- 分类器所填内容如图11所示
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image11.jpg" alt="问题分类器配置" width="80%"/>
  图11 问题分类器配置
...
- 后续我们直接用节点flow进行说明每个模块的flow
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image12.jpg" alt="日常助手模块配置" width="90%"/>
  图12 日常助手模块配置
...
如图13所示：
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image13.png" alt="日常助手演示效果" width="80%"/>
  图13 日常助手演示效果
...
如图14所示：
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image14.png" alt="文案优化演示效果" width="80%"/>
  图14 文案优化演示效果
...
- flow中各节点分别为"开始-问题分类器-豆包T2I-直接回复"
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image15.jpg" alt="豆包生图flow配置" width="90%"/>
  图15 豆包生图flow配置
...
如图16所示：
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image16.png" alt="豆包生图效果展示" width="80%"/>
  图16 豆包生图效果展示
...
- 文生视频flow中各节点分别为"开始-问题分类器-豆包T2V-直接回复"
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image17.jpg" alt="文生视频权限开通" width="90%"/>
  图17 文生视频权限开通
...
如图18所示：
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image18.png" alt="豆包生视频效果展示" width="80%"/>
  图18 豆包生视频效果展示
...
5. 填写相应的提示词
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image19.jpg" alt="MCP工具集成配置步骤" width="90%"/>
  图19 MCP工具集成配置步骤
...
- MCP服务调用的flow中各节点分别为"开始-问题分类器-Agent-直接回复"
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image20.jpg" alt="Agent节点配置详情" width="50%"/>
  图20 Agent节点配置详情
...
- 高德助手效果：如图21所示
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image21.png" alt="高德助手效果展示" width="80%"/>
  图21 高德助手效果展示
...
- 饮食助手效果：如图22所示
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image22.png" alt="饮食助手效果展示" width="80%"/>
  图22 饮食助手效果展示
...
- 新闻助手效果：如图23所示
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image23.png" alt="新闻助手效果展示" width="50%"/>
  图23 新闻助手效果展示
...
配置数据库连接信息（IP地址、数据库名称、端口、账号、密码等），如图24所示。查询结果需要通过大模型节点进行整理，转换为易于理解的自然语言输出。
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image24.png" alt="数据库配置" width="50%"/>
  图24 数据库配置
...
效果展示如图25所示：
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image25.png" alt="数据查询助手效果" width="80%"/>
  图25 数据查询助手
...
```
  ...
  <img src="/original-assets/hello-agents/Extra-Chapter/images/Extra03-figures/image26.png" alt="数据分析助手效果" width="80%"/>
  图26 数据分析助手
