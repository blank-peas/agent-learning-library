...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Co-creation-projects/tino-chen-HelloClaw/README.md`。


> 基于 HelloAgents 框架的个性化 AI Agent 应用，支持身份定制、记忆系统和流式工具调用


  <img src="/original-assets/hello-agents/Co-creation-projects/tino-chen-HelloClaw/outputs/helloclaw.png" alt="HelloClaw Screenshot" width="80%"/>
