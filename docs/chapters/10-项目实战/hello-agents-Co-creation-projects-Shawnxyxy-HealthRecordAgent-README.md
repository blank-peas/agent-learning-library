...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Co-creation-projects/Shawnxyxy-HealthRecordAgent/README.md`。
...
![档案与报告](/original-assets/hello-agents/Co-creation-projects/Shawnxyxy-HealthRecordAgent/frontend/screenshots/report.png)

**饮食推荐**（`diet.png`）

![饮食推荐](/original-assets/hello-agents/Co-creation-projects/Shawnxyxy-HealthRecordAgent/frontend/screenshots/diet.png)

**执行反馈 Reflect**（`reflect.png`）

![执行反馈 Reflect](/original-assets/hello-agents/Co-creation-projects/Shawnxyxy-HealthRecordAgent/frontend/screenshots/reflect.png)
