...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Co-creation-projects/usernamedadad-AutoFlow/README.md`。
...
![灵感模式示例](/original-assets/hello-agents/Co-creation-projects/usernamedadad-AutoFlow/data/images/demo-inspire-mode.png)
...
![创造模式示例](/original-assets/hello-agents/Co-creation-projects/usernamedadad-AutoFlow/data/images/demo-create-mode.png)
