...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Co-creation-projects/melxy1997-ColumnWriter/README.md`。


一个基于 [HelloAgents](https://github.com/helloagents/hello-agents) 框架构建的智能专栏写作系统，采用多智能体/多设计模式，自动完成专栏的规划、撰写、评审和优化。
![执行截图](/original-assets/hello-agents/Co-creation-projects/melxy1997-ColumnWriter/assets/agent_run.jpg)
...
![缓存机制](/original-assets/hello-agents/Co-creation-projects/melxy1997-ColumnWriter/assets/feature_cache.jpg)
...
![解析恢复](/original-assets/hello-agents/Co-creation-projects/melxy1997-ColumnWriter/assets/feature_robust.jpg)
...
![查看输出结果](/original-assets/hello-agents/Co-creation-projects/melxy1997-ColumnWriter/assets/feature_output.jpg)
