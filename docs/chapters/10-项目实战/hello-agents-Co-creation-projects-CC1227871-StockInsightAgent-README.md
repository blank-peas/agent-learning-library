...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Co-creation-projects/CC1227871-StockInsightAgent/README.md`。
...
```
![alt text](/original-assets/hello-agents/Co-creation-projects/CC1227871-StockInsightAgent/image.png)
运行app.py后，在浏览器打开http://127.0.0.1:7861便可进入交互界面
![alt text](/original-assets/hello-agents/Co-creation-projects/CC1227871-StockInsightAgent/image-1.png)
