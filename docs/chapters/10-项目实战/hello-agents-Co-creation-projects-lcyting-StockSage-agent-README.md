...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Co-creation-projects/lcyting-StockSage-agent/README.md`。
...
详细部署说明见 [DEPLOY.md](./chapters/10-项目实战/hello-agents-Co-creation-projects-lcyting-StockSage-agent-DEPLOY)
