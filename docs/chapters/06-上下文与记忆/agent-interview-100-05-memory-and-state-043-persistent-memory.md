...
> **资料来源**：[Agent Interview 100](https://github.com/BigKunLun/Agent-Interview-100) · 原文件：`05-memory-and-state/043-persistent-memory.md`。
...
*持久化记忆 = Agent 挂双引擎（提取落库 + 检索回灌），底层是向量 / 关系 / 图三库持久层。*
