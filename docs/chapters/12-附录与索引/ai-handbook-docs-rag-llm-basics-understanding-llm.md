...
> **资料来源**：[AI Handbook](https://github.com/nageoffer/ai-handbook) · 原文件：`docs/rag/llm-basics/understanding-llm.md`。
...
![](https://oss.open8gu.com/image-20260222130016616.png)
...
>
> A 管单独注满需要 6 小时，所以 A 管每小时注入水池的 1/6。
> B 管单独注满需要 8 小时，所以 B 管每小时注入水池的 1/8。
>
> 两管同时开，每小时注入量 = 1/6 + 1/8。
> 通分：1/6 = 4/24，1/8 = 3/24。
> 所以每小时注入量 = 4/24 + 3/24 = 7/24。
>
...
![](https://oss.open8gu.com/image-20260222133901342.png)
