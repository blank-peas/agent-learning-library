...
> **资料来源**：[AI Agent Interview Guide](https://github.com/bcefghj/ai-agent-interview-guide) · 原文件：`README.md`。


![面试攻略](/original-assets/ai-agent-interview-guide/comics/06-面试场景.png)
...
| 漫画 | 对应知识点 |
|------|------------|
| [什么是 AI Agent](/original-assets/ai-agent-interview-guide/comics/01-什么是Agent.png) | Agent 的定义与核心组成 |
| [ReAct 循环](/original-assets/ai-agent-interview-guide/comics/02-ReAct循环.png) | Thought → Action → Observation 循环 |
| [RAG 流程](/original-assets/ai-agent-interview-guide/comics/03-RAG流程.png) | 检索增强生成的完整流程 |
| [多 Agent 协作](/original-assets/ai-agent-interview-guide/comics/04-多Agent协作.png) | 多智能体分工与协作模式 |
| [记忆系统](/original-assets/ai-agent-interview-guide/comics/05-记忆系统.png) | 短期记忆 vs 长期记忆 |
| [面试场景](/original-assets/ai-agent-interview-guide/comics/06-面试场景.png) | 从零到 Offer 的面试之旅 |
...
本项目采用 [MIT License](https://github.com/bcefghj/ai-agent-interview-guide) 开源。
