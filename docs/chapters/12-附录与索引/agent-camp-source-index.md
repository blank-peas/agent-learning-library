...
> **资料来源**：[Agent Camp](https://github.com/yibo365/agent-camp) · 原文件：`source/index.md`。
...
1. 想理解 Agent 设计哲学，从 **Claude Code** 与 **Codex CLI** 入手
2. 想理解 IDE 内 Agent 实现，看 **Cline**
3. 想了解学术前沿，看 **SWE-agent**
4. 想做浏览器 Agent，看 **Browser Use**
