...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`README.md`。
...
- 🛠️ 自研框架 [HelloAgents](https://github.com/jjyaoao/helloagents) 基于 Openai 原生 API 从零构建一个自己的智能体框架
...
| 章节                                                                                        | 关键内容                                      | 状态 |
| ------------------------------------------------------------------------------------------- | --------------------------------------------- | ---- |
| [前言](./chapters/07-ts产品工程/hello-agents-docs-前言)                                                                      | 项目的缘起、背景及读者建议                    | ✅    |
| 第一部分：智能体与语言模型基础                                             |                                               |      |
| [第一章 初识智能体](https://github.com/datawhalechina/hello-agents)                                 | 智能体定义、类型、范式与应用                  | ✅    |
| [第二章 智能体发展史](https://github.com/datawhalechina/hello-agents)                             | 从符号主义到 LLM 驱动的智能体演进             | ✅    |
| [第三章 大语言模型基础](https://github.com/datawhalechina/hello-agents)                         | Transformer、提示、主流 LLM 及其局限          | ✅    |
| 第二部分：构建你的大语言模型智能体                                         |                                               |      |
| [第四章 智能体经典范式构建](https://github.com/datawhalechina/hello-agents)                 | 手把手实现 ReAct、Plan-and-Solve、Reflection  | ✅    |
| [第五章 基于低代码平台的智能体搭建](https://github.com/datawhalechina/hello-agents) | 了解 Coze、Dify、n8n 等低代码智能体平台使用   | ✅    |
| [第六章 框架开发实践](https://github.com/datawhalechina/hello-agents)                             | AutoGen、AgentScope、LangGraph 等主流框架应用 | ✅    |
| [第七章 构建你的Agent框架](https://github.com/datawhalechina/hello-agents)                   | 从 0 开始构建智能体框架                       | ✅    |
| 第三部分：高级知识扩展                                                     |                                               |      |
| [第八章 记忆与检索](https://github.com/datawhalechina/hello-agents)                                 | 记忆系统，RAG，存储                           | ✅    |
| [第九章 上下文工程](https://github.com/datawhalechina/hello-agents)                                 | 持续交互的"情境理解"                          | ✅    |
| [第十章 智能体通信协议](https://github.com/datawhalechina/hello-agents)                        | MCP、A2A、ANP 等协议解析                      | ✅    |
| [第十一章 Agentic-RL](https://github.com/datawhalechina/hello-agents)                            | 从 SFT 到 GRPO 的 LLM 训练实战                | ✅    |
| [第十二章 智能体性能评估](https://github.com/datawhalechina/hello-agents)                    | 核心指标、基准测试与评估框架                  | ✅    |
| 第四部分：综合案例进阶                                                     |                                               |      |
| [第十三章 智能旅行助手](https://github.com/datawhalechina/hello-agents)                        | MCP 与多智能体协作的真实世界应用              | ✅    |
| [第十四章 自动化深度研究智能体](https://github.com/datawhalechina/hello-agents)        | DeepResearch Agent 复现与解析                 | ✅    |
| [第十五章 构建赛博小镇](https://github.com/datawhalechina/hello-agents)                        | Agent 与游戏的结合，模拟社会动态              | ✅    |
| 第五部分：毕业设计及未来展望                                               |                                               |      |
| [第十六章 毕业设计](https://github.com/datawhalechina/hello-agents)                                | 构建属于你的完整多智能体应用                  | ✅    |
...
&emsp;&emsp;智能体是一个飞速发展且极度依赖实践的领域。为了获得最佳的学习效果，我们在项目的`code`文件夹内提供了配套的全部代码，强烈建议你将理论与实践相结合。请务必亲手运行、调试甚至修改项目里提供的每一份代码。欢迎你随时关注 Datawhale 以及其他 Agent 相关社区，当遇到问题时，你可以随时在本项目的 issue 区提问。
...
- 感谢大家助力7W Star! 现在提供调查问卷，供大家填写自己需要学习的智能体内容。后续作品《从零开始训练智能体》，帮助每一个学习者掌握从零到一训练自定义场景智能体模型的能力。
    ...
    <img src="/original-assets/hello-agents/读者反馈问卷.png" alt="读者反馈问卷" width="30%">
...
### 读者交流群
    ...
    <img src="/original-assets/hello-agents/读者群二维码.png" alt="读者群二维码" width="30%">
