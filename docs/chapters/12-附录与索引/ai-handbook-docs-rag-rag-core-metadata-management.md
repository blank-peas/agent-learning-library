...
> **资料来源**：[AI Handbook](https://github.com/nageoffer/ai-handbook) · 原文件：`docs/rag/rag-core/metadata-management.md`。
...
public class CitationExample {
    ...
    public static String generateCitation(Document chunk) {
        ...
        if (sourceUrl != null) {
            citation.append("\n\n[查看原文](https://github.com/nageoffer/ai-handbook).append(sourceUrl).append(")");
        }
