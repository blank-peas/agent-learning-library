...
> **资料来源**：[Agent Camp](https://github.com/yibo365/agent-camp) · 原文件：`llm/training.md`。
...
读完这篇你要能正面回答下面这些题。每题后面括号里是面试官真正想看你答出什么。
    ...
    Base Model、Instruct Model、Chat Model、Reasoning Model 各是什么阶段的产物？
    考你能不能把训练阶段和模型形态对应起来。
  

  
    为什么预训练完不能直接用？必须做 SFT？
    考对"对齐"问题本质的理解。
  

  
    RLHF 的三步流程是什么？为什么需要 reward model 这一步？
    RLHF 经典考题，要能讲清楚 SFT → RM → PPO 三阶段。
  

  
    DPO 和 RLHF/PPO 比起来，最大的优势是什么？为什么 2024 年后大家都用 DPO？
    考你跟得上时代，DPO 已是新主流。
  

  
    LoRA 是什么？跟全参数 fine-tune 比效果差多少？什么时候必须全参 fine-tune？
    考工程实战，PEFT 现在是标配。
  

  
    SFT 数据要多少？为什么"少而精"比"多而杂"好？
    考 LIMA 论文的洞察，新人不知道。
  

  
    Constitutional AI、RLAIF 又是什么？为什么 Anthropic 走这条路？
    考前沿，区分"听说过"和"理解了"。
