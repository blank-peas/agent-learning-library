...
> **资料来源**：[Agent Interview 100](https://github.com/BigKunLun/Agent-Interview-100) · 原文件：`07-prompt-engineering/065-programmatic-prompt-optimization.md`。
...
| 维度 | DSPy（编程化） | 元提示（APE/OPRO/PromptBreeder） |
|------|----------------|----------------------------------|
...
| 优化算法 | BootstrapFewShot / MIPROv2 / SIMBA / BootstrapFinetune | 候选生成 / 迭代 / 进化 |
