# Self-Consistency 与 Self-Refine

> **资料来源**：[Agent Camp](https://github.com/yibo365/agent-camp) · 原文件：`prompt/self-consistency.md`。
...
## Self-Consistency 与 Self-Refine
  ...
  Self-Consistency 用多次采样投票，Self-Refine 让模型自我打分修正——两个简单技巧，效果常常比换更强的模型还显著。
...
读完这篇你要能正面回答下面这些题。每题后面括号里是面试官真正想看你答出什么。
    ...
    Self-Consistency 是怎么工作的？为什么"多次采样投票"能提准确率？
    考对概率分布与众数的直觉。
  

  
    Self-Consistency 必须配合 CoT 用吗？直接对答案投票行不行？
    考你能不能讲清"推理多样性"为什么重要。
  

  
    采样几次合适？10 次和 40 次效果差多少？
    考工程权衡，没有标准答案。
  

  
    Self-Refine 和 Self-Consistency 区别是什么？什么场景用哪个？
    考概念辨析。
  

  
    Self-Refine 在某些任务上反而越改越差，为什么？
    考你知不知道 Huang et al. 2023 的反向发现。
  

  
    Reflexion 是 Self-Refine 的进化吗？多了哪一步？
    考对 Agent 自我反思的理解。
  

  
    这些技巧的 hidden cost 是什么？为什么生产里要慎用？
    考成本意识。
