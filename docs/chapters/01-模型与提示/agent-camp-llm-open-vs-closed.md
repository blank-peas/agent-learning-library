...
> **资料来源**：[Agent Camp](https://github.com/yibo365/agent-camp) · 原文件：`llm/open-vs-closed.md`。
...
## 开源 vs 闭源选型
  ...
  不是哪个更强的问题，是在你的约束下哪个 TCO 更低、风险更小——一份决策矩阵。
...
读完这篇你要能正面回答下面这些题。每题后面括号里是面试官真正想看你答出什么。
    ...
    什么样的业务场景必须用开源模型？什么场景闭源更优？
    考你能不能给出具体决策维度，不能只说"看情况"。
  

  
    开源模型自部署的真实成本怎么算？只算 GPU 钱够吗？
    考 TCO 思维，运维/工程/人力都要算进去。
  

  
    "开源 = 免费"是误解吗？多大调用量自部署才划算？
    考具体测算能力，能不能给出盈亏平衡点。
  

  
    同 size 的开源和闭源模型，效果差距 2024-2025 缩小到了多少？
    考你跟得上当前进度。
  

  
    用 OpenAI API 的数据合规风险有哪些？怎么缓解？
    考合规意识，特别是出海/金融/医疗场景。
  

  
    开源模型的 license 有哪些坑？哪些真免费、哪些有商用限制？
    考工程上线前必查项。
