...
> **资料来源**：[Agent Interview 100](https://github.com/BigKunLun/Agent-Interview-100) · 原文件：`03-tool-use/022-tool-schema-design.md`。
...
def validate_and_execute(tool_name: str, llm_args: dict):
    ...
    # 3. 执行
    return tools[tool_name](https://github.com/BigKunLun/Agent-Interview-100)
```
