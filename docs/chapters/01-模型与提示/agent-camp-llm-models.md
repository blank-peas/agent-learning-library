...
> **资料来源**：[Agent Camp](https://github.com/yibo365/agent-camp) · 原文件：`llm/models.md`。
...
## 主流模型横向对比
  ...
  GPT / Claude / Gemini / Llama / Qwen / DeepSeek——六大主流模型的技术路线、强弱场景、选型决策。
...
读完这篇你要能正面回答下面这些题。每题后面括号里是面试官真正想看你答出什么。
    ...
    GPT-4 / Claude / Gemini 在能力上各有什么强项？为什么会有差异？
    考你能不能用一两个具体场景区分，而不是空说"都很强"。
  

  
    Llama 3、Qwen、DeepSeek 这些开源模型，能力和闭源差距有多大？
    考你跟得上开源进度，2024 后差距快速缩小。
  

  
    MoE 架构是什么？为什么 DeepSeek-V3、Qwen3、Mixtral 都用 MoE？
    考前沿架构理解，2024 后开源主流都转向 MoE。
  

  
    推理模型（o1、R1、Claude Thinking）和普通对话模型本质区别是什么？
    考对 reasoning-time compute scaling 的认知。
  

  
    给定一个业务场景，怎么决定用哪个模型？决策依据有哪些？
    考工程权衡，能不能给出 cost / latency / quality 多维决策框架。
  

  
    同样规模的模型，为什么 DeepSeek 训练成本只有 GPT 的几十分之一？
    考对 MoE + 训练效率优化的理解。
  

  
    怎么用 LLM Arena、MMLU、HumanEval 等 benchmark？哪些可信、哪些有坑？
    考评估方法论。
