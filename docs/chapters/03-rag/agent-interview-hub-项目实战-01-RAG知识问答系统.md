...
> **资料来源**：[Agent Interview Hub](https://github.com/Zchary1106/agent-interview-hub) · 原文件：`项目实战/01-RAG知识问答系统.md`。
...
![RAG 混合检索与生成链路](/original-assets/agent-interview-hub/diagrams/rag-hybrid-retrieval-flow.svg)

#### 离线数据摄入流

![RAG 文档入库流水线](/original-assets/agent-interview-hub/diagrams/document-ingestion-pipeline.svg)
...
**回答**：
> ![RAG 系统部署拓扑](/original-assets/agent-interview-hub/diagrams/rag-deployment-topology.svg)
>
