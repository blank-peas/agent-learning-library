...
> **资料来源**：[AI Agent Interview Guide](https://github.com/bcefghj/ai-agent-interview-guide) · 原文件：`docs/01-面试八股文/03-RAG技术.md`。


![RAG流程](/original-assets/ai-agent-interview-guide/comics/03-RAG流程.png)
...
**概念解释**  
利用 `# 标题` 或 HTML 的 `` / 标题标签，把 **同一小节** 作为块或父文档。
