...
> **资料来源**：[Agent Interview 100](https://github.com/BigKunLun/Agent-Interview-100) · 原文件：`02-rag/013-chunking-strategies.md`。
...
| 维度 | 小块（100-200 tokens） | 大块（1000-2000 tokens） |
|------|----------------------|------------------------|
| 检索精度 | 高，匹配更精确 | 相关性被稀释，匹配变粗 |
| Embedding 语义 | 语义集中 | 语义被稀释 |
| 上下文 | 可能丢失上下文 | 信息丰富，保持段落完整性 |
| 存储 | 需要更多块 → 更多存储 | 块数少，存储成本更低 |
| 无关信息 | 不易混入无关内容 | 可能包含无关信息 |
