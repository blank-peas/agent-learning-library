...
> **资料来源**：[Agent Interview Hub](https://github.com/Zchary1106/agent-interview-hub) · 原文件：`通用知识/模型微调完全指南.md`。
...
![模型微调技术演进时间线](/original-assets/agent-interview-hub/diagrams/finetuning-evolution-timeline.svg)
...
![Warmup + Cosine 学习率曲线](/original-assets/agent-interview-hub/diagrams/learning-rate-warmup-cosine.svg)
...
![DeepSpeed ZeRO 三阶段对比](/original-assets/agent-interview-hub/diagrams/deepspeed-zero-stages.svg)
...
![LoRA 低秩适配器结构](/original-assets/agent-interview-hub/diagrams/lora-adapter-flow.svg)
...
![QLoRA 训练结构](/original-assets/agent-interview-hub/diagrams/qlora-training-stack.svg)
...
![微调方法资源对比](/original-assets/agent-interview-hub/diagrams/finetune-method-comparison.svg)
...
![RLHF 三阶段训练流程](/original-assets/agent-interview-hub/diagrams/rlhf-three-stage-flow.svg)
...
![PPO 训练循环](/original-assets/agent-interview-hub/diagrams/ppo-training-loop.svg)
...
![训练规模与典型配置](/original-assets/agent-interview-hub/diagrams/training-scale-playbook.svg)
...
![微调显存估算速查](/original-assets/agent-interview-hub/diagrams/finetune-memory-estimation.svg)
