...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Extra-Chapter/Extra08-如何写出好的Skill.md`。
...
![目录](/original-assets/hello-agents/Extra-Chapter/images/Extra08-figures/toc.png)
...
![Skill 标准结构与三级加载](/original-assets/hello-agents/Extra-Chapter/images/Extra08-figures/skill-structure.png)
...
![自由度光谱](/original-assets/hello-agents/Extra-Chapter/images/Extra08-figures/freedom-spectrum.png)
...
![六步创建流程](/original-assets/hello-agents/Extra-Chapter/images/Extra08-figures/creation-flow.png)

理解→规划→初始化→编辑→校验→迭代。其中脚本贯穿流程，形成确定性的质量保障链：

![文件交互关系](/original-assets/hello-agents/Extra-Chapter/images/Extra08-figures/file-interaction.png)
...
### Advanced features
- **Form filling**: See [FORMS.md](https://github.com/datawhalechina/hello-agents) for complete guide
- **API reference**: See [REFERENCE.md](https://github.com/datawhalechina/hello-agents) for all methods
- **Examples**: See [EXAMPLES.md](https://github.com/datawhalechina/hello-agents) for common patterns
```
...
### Creating documents
Use docx-js for new documents. See [DOCX-JS.md](https://github.com/datawhalechina/hello-agents).

### Editing documents
For simple edits, modify the XML directly.

**For tracked changes**: See [REDLINING.md](https://github.com/datawhalechina/hello-agents)
**For OOXML details**: See [OOXML.md](https://github.com/datawhalechina/hello-agents)
```
