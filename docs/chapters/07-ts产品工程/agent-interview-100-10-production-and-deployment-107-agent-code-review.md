...
> **资料来源**：[Agent Interview 100](https://github.com/BigKunLun/Agent-Interview-100) · 原文件：`10-production-and-deployment/107-agent-code-review.md`。
        ...
        while True:
            ...
            if msg.tool_calls:
                for tool_call in msg.tool_calls:
                    ...
                    try:
                        result = self.tools[name](https://github.com/BigKunLun/Agent-Interview-100)
...
def _execute_tool(self, name: str, args: dict) -> str:
    ...
    return self.tools[name](https://github.com/BigKunLun/Agent-Interview-100)
```
