...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`docs/chapter7/Chapter7-Building-Your-Agent-Framework.md`。
...
def _eval_node(node, operators, functions):
    ...
    if isinstance(node, ast.Constant):
        ...
        if func_name in functions:
            ...
            return functions[func_name](https://github.com/datawhalechina/hello-agents)
...
1. This chapter built the `HelloAgents` framework and explained "why we need to build our own Agent framework." Please analyze:
   ...
   - Section 7.1.1 mentioned four main limitations of current mainstream frameworks. Combined with your actual experience using a framework in [Chapter 6 exercises](https://github.com/datawhalechina/hello-agents) or actual projects, explain how these problems affect development efficiency.
