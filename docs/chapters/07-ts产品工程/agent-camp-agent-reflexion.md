# 自我反思 Reflexion / Self-Refine

> **资料来源**：[Agent Camp](https://github.com/yibo365/agent-camp) · 原文件：`agent/reflexion.md`。
...
## 自我反思 Reflexion / Self-Refine
  ...
  Reflexion 把失败反馈写成可复用经验，让下一次尝试少犯同样的错。

  
    适合阶段：多轮尝试与失败复盘
    核心机制：Actor / Evaluator / Reflector / Memory
    面试重点：反思质量与评估信号
...
读完这篇你要能正面回答下面这些题。每题后面括号里是面试官真正想看你答出什么。
    ...
    Reflexion 和普通 retry 有什么区别？
    考失败反馈是否写入长期或短期经验。
  

  
    Reflexion 需要什么 evaluator？没有反馈信号还能用吗？
    考自动评测、工具反馈、人工反馈和弱监督。
  

  
    Self-Refine、CRITIC、Reflexion 的差异是什么？
    考自反馈、工具交互批判、语言反思记忆。
  

  
    反思内容应该怎么存？存自然语言还是结构化字段？
    考 memory schema、检索和污染控制。
    ...
    代码 Agent 里 Reflexion 怎么落到工程上？
    考测试失败、patch、错误摘要、下一轮约束。
  

  
    Reflexion 怎么评估？
    考 first-pass success、retry success、reflection usefulness。
