...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`Extra-Chapter/Extra04-DatawhaleFAQ.md`。
...
- 要点整理：
  - RL、LLM、RLHF 都更像是 Agent 的组成部分或实现技术，而不是一个单独的“Agent 类型”。
...
- 要点整理：
  ...
  - modelscope社区的模型api获取方法 https://www.modelscope.cn/models/Qwen/Qwen3-VL-8B-Instruct
    ...
    - ![alt text](/original-assets/hello-agents/Extra-Chapter/images/Extra04-figures/3f1b68eedc9d9e556fbb51358bf49f9d.png)
    - ![alt text](/original-assets/hello-agents/Extra-Chapter/images/Extra04-figures/e7dd177f-4867-4af0-bd0e-03771a3a040e.png)
