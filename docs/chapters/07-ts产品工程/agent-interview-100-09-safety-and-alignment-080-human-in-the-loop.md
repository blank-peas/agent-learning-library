...
> **资料来源**：[Agent Interview 100](https://github.com/BigKunLun/Agent-Interview-100) · 原文件：`09-safety-and-alignment/080-human-in-the-loop.md`。
...
| Amazon Bedrock Agents | 内置 user confirmation 功能
可配置哪些工具需要确认 |
