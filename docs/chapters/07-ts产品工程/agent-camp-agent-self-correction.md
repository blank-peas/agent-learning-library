...
> **资料来源**：[Agent Camp](https://github.com/yibo365/agent-camp) · 原文件：`agent/self-correction.md`。
...
## 自我纠错 Self-Correction
  ...
  自我纠错要用验证器、工具反馈和回滚机制把错误挡在输出前。

  
    适合阶段：输出可靠性与安全
    核心机制：Detect / Repair / Verify / Commit
    面试重点：纠错需要外部信号
...
读完这篇你要能正面回答下面这些题。每题后面括号里是面试官真正想看你答出什么。
    ...
    Self-correction 和 Reflexion 有什么区别？
    考本轮修复和跨轮经验写入的差异。
  

  
    纠错 loop 应该怎么设计？
    考 detect、repair、verify、commit、rollback。
  

  
    哪些错误适合自动纠正，哪些必须拒绝或转人工？
    考风险分级和副作用控制。
  

  
    结构化输出纠错怎么做？
    考 schema validation、json repair、typed output。
  

  
    代码 Agent 自我纠错怎么实现？
    考单测、lint、patch、回滚、diff 审计。
  

  
    怎么评估纠错机制有没有帮忙？
    考 first-pass vs after-repair、false repair、cost。
