...
> **资料来源**：[Hello-Agents](https://github.com/datawhalechina/hello-agents) · 原文件：`docs/chapter1/Chapter1-Introduction-to-Agents.md`。
...
- **Neuro-symbolic AI** combines the pattern recognition of System 1 with the logical reasoning of System 2, enabling the two to work together.
  ...
  Figure 1.4 Knowledge representation paradigms of sub-symbolism, symbolism, and neuro-symbolic hybrid
...
for i in range(5): # Set maximum number of loops
    ...
    if tool_name in available_tools:
        observation = available_tools[tool_name](https://github.com/datawhalechina/hello-agents)
    else:
